...
export const AccountCertificates = ({ headerName, certificates, setShowFilter }: { headerName: string, certificates: any[], setShowFilter: (val: boolean) => void }) => {
    return (
        <>
            <div className="w-full flex flex-col ">
                <div className="w-full px-6 py-4 gap-x-3 shadow-sm flex items-center">
            ...
            <div className="w-full px-6 py-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    ...
                    >
                        <div className="relative aspect-video overflow-hidden">
                        <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-lg shadow-sm">
                            <span className="text-xs font-bold text-indigo-600">{certificate.issuer.toString()}</span>
                        </div>
                        </div>
